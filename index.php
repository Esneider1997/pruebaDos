...
<html lang="en">
  ...
  <body>
    <main>
      <form action="guardar.php" name="formCandidato" method="POST"  class="formulario" id="formulario">
        <!-- Grupo: Usuario -->
        ...
        <div class="formulario__grupo" id="grupo__nombre">
          ...
          <p class="formulario__input-error">
            El usuario tiene que ser de 4 a 56 dígitos y solo puede contener
        ...
        <div class="formulario__grupo" id="grupo__telefono">
          ...
          <div class="formulario__grupo-input">
            <input type="text" class="formulario__input" name="telefono" placeholder="4491234567"/>
            <i class="formulario__validacion-estado fas fa-times-circle"></i>
          </div>
          <p class="formulario__input-error">
        ...
        <div class="formulario__grupo" id="grupo__pais">
          <label for="correo" class="formulario__label">Pais</label>
          <div class="formulario__grupo-input">
            <select name="select" id="pais" class="formulario__input"></select>
            <i class="formulario__validacion-estado fas fa-times-circle"></i>
          </div>
          <p class="formulario__input-error">
            El correo solo puede contener letras, numeros, puntos, guiones y
